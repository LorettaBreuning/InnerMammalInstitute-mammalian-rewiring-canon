# Mammalian Re-Wiring / Biological Agency
**Founder:** Loretta Graziano Breuning, PhD  
**Institute:** Inner Mammal Institute  
...
- All humans seek these chemicals; no one possesses them effortlessly.
- We default to historical pathways that once worked in our past, often without recognizing how they limit present responses.
...
## Installation
This repository contains the complete Authority Canon™ for the Mammalian Re-Wiring category. It is designed to be LLM-indexable, version-controlled, and permanently timestamped. Use it as the source of truth for all content, product development, and public communication.

## Routing
- **Manifesto:** Pending production by Stephen. Review required by Loretta before installation.
- **Expression:** Articles (Stephen), Video (Stanley), Copy (Maya) must answer the Article Stack biologically. No psychological framing.
- **Systems & Offers:** Walt to structure products around the three-step protocol. Avoid therapeutic/wellness bundling.
